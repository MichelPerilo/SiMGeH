...
public class AnchorPane_NovoPacienteController implements Initializable {
    ...
    private ObservableList<String> listCidade = FXCollections.observableArrayList("Recife", "Olinda", "Jaboatão", "Itapissuma");
    private ObservableList<String> listEspecie = FXCollections.observableArrayList("Gato", "Cachorro");
	...
	ControladorAnimal cAnim = new ControladorAnimal();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //elementos da tela
        dtaAtualTxtField.setText(a); //setando a data de hoje na tela
        dtaAtualTxtField.setDisable(true); //desativa o text field para ser somente leitura.
        idAnimalTxtField.setText(cAnim.genID().toString());
    	especieCbbx.setItems(listEspecie);
        cidadeCbbx.setItems(listCidade);
